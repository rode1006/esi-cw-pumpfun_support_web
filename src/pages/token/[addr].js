...
export default function TokenPage() {
      ...
      <div className='flex flex-col gap-4 p-6 '>
        <div className='flex gap-[22px] items-start'>
          ...
          <div className='flex flex-col gap-2'>
            ...
            <p className='text-xs font-medium text-[#dfdfdf]'
              style={{
                overflow: 'hidden',
                display: '-webkit-box',
                WebkitLineClamp: 4,
  ...
  return (
    <section className={`z-10 flex flex-col sm:flex-row p-12 justify-center gap-8`}>
      <div className="z-10 flex sm:hidden flex-col border-2 w-full">
        <div className="flex">
        ...
        <div className='flex flex-col gap-5 p-6'>
          <div className='relative'>
            <input value={amount} onChange={onChangeAmount} type='number' className='px-6 py-4 bg-[#3a3a3a77] placeholder-white h-[66px] text-sm border border-white text-[#808080] w-full rounded-lg' placeholder='0.0' />
            {currentMode === 'buy' ? (
      ...
      <div className='z-10 flex flex-col sm:w-[60%] px-1'>
        {isPoolComplete === true && (
          <div className='flex items-center gap-2 bg-[#86efac] p-4 rounded-md w-fit'>
            ...
            <a href={`https://dexscreener.com/${addr}`} target='_blank' className='text-xl font-medium hover:underline text-[#3a3dee]'>here</a>
          </div>
        )}
        ...
        {/* <Chart /> */}
        <iframe className={`h-[600px]`} src={`https://dexscreener.com/solana/${tokenInfo?.mint}?embed=1&theme=dark&trades=0&info=0`}></iframe>
      </div>
      <div className="z-10 hidden sm:flex border-2 flex-col sm:max-w-sm w-full pb-20">
